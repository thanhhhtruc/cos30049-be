...
export namespace $default {
  export interface CryptoExchangeRate extends std.$Object {
    "rate": number;
    "updatedAt": Date;
  ...
  export interface Currency extends std.$Object {
    ...
    "name": string;
    "symbol": string;
    "exchangeRates": CryptoExchangeRate[];
  }
...
export type CryptoExchangeRate = $default.CryptoExchangeRate;
...
export interface types {
  ...
  "default": {
    "CryptoExchangeRate": $default.CryptoExchangeRate;
