...
export namespace $default {
  ...
  export interface ExchangeRate extends std.$Object {
  ...
  export interface Wallet extends std.$Object {
    "currency": Currency;
    "address": string;
    "balance": number;
    "type": WalletType;
...
export type ExchangeRate = $default.ExchangeRate;
export type Transaction = $default.Transaction;
export type User = $default.User;
export type Wallet = $default.Wallet;
export type WalletType = $default.WalletType;
...
export interface types {
  ...
  "default": {
    ...
    "ExchangeRate": $default.ExchangeRate;
    "Transaction": $default.Transaction;
    "User": $default.User;
    "Wallet": $default.Wallet;
    "WalletType": $default.WalletType;
  };
  "fts": {
